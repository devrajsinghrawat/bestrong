        ...
        <v-container fluid>
          <v-row>
            <v-col v-for="i in 6" :key="i" cols="12" md="4">
              ...
              <div class="overline mb-4" v-if="i == 4">Net Company Balance</div>
              ...
              >
                ...
                <v-list-item-title class="display-4 green--text" v-if="i == 5">
                ...
                <v-list-item-title class="display-4 green--text" v-if="i == 6">
